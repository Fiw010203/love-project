...
const memories = [
  { text: "ตั้งแต่ที่เราเริ่มคุยกัน… 😊มันกลายเป็นช่วงเวลาที่เราชอบมากเลยนะ", img: "/images/1.jpg" },
  { text: "อยู่ ๆ ก็รู้สึกว่าการมีเธออยู่ในแต่ละวันมันดีขึ้นจริง ๆแบบที่ไม่เคยคิดมาก่อนเลย", img: "/images/2.jpg" },
  { text: "เราเริ่มรู้สึกดีกับเธอมากขึ้นเรื่อย ๆจนไม่อยากให้มันเป็นแค่ “คุยเล่น ๆ” อีกแล้ว", img: "/images/3.jpg" },
  { text: "เลยอยากลองถามอะไรบางอย่าง…ที่เราคิดมาสักพักแล้ว", img: "/images/4.jpg" }
]
